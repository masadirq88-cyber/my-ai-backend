...
class ExecutiveManager:
    def __init__(self, api_key: str):
        ...
        # قائمة الوكلاء كاملة ومدمجة من الأجزاء السابقة والجديدة
        raw_agents = [
            ("CEO Agent", "أنت المدير التنفيذي وتنسيق العمليات. قم بإدارة الأولويات وتوجيه الاستراتيجيات العامة."),
            ("Dev_Agent", "أنت مهندس برمجيات محترف ومتخصص في منطق وحسابات Dart وتطوير Flutter والمواقع."),
            ("UI_Agent", "أنت مصمم واجهات خبير متخصص في Flutter UI/UX. أنشئ ويدجيتس عصرية وجذابة."),
            ...
            ("ContentWriter_Agent", "أنت كاتب محتوى وموثق تقني. صمم الأدلة والمقالات والوثائق الرسمية."),
